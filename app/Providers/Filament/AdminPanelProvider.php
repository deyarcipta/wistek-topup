            ...
            ->renderHook(
                ...
                fn () => new HtmlString('
                    <style>
                        ...
                        /* ========================================================
                           Level 1 Menus: Dasbor, Transaksi, & Menu Utama Dropdown
                           Disamakan 100% Presisi (Padding, Gap, Icon Size, Font & Weight)
                           ======================================================== */
                        ...
                        /* Hover State: Light Mode vs Dark Mode */
                        .fi-sidebar-group-btn:hover,
                        .fi-sidebar-group:not([data-group-label]) .fi-sidebar-item-btn:hover,
                        .fi-sidebar-group[data-group-label=""] .fi-sidebar-item-btn:hover {
                        ...
                        /* Level 1 Label: Dark Gray (#1f2937) di Light Mode, Putih Terang (#f3f4f6) di Dark Mode */
                        ...
                        /* Level 1 Icons: Ukuran 1.5rem x 1.5rem */
                        ...
                        /* INACTIVE Icons Light Mode (#4b5563) */
                        ...
                        /* INACTIVE Icons Dark Mode (#9ca3af) */
                        ...
                        /* ACTIVE State: Amber (#d97706 di Light Mode, #f59e0b di Dark Mode) */
                        .fi-sidebar-group.group-is-active .fi-sidebar-group-label,
                        .fi-sidebar-group.fi-active .fi-sidebar-group-label,
                        .fi-sidebar-group:not([data-group-label]) .fi-sidebar-item.fi-active .fi-sidebar-item-label,
                        .fi-sidebar-group[data-group-label=""] .fi-sidebar-item.fi-active .fi-sidebar-item-label {
